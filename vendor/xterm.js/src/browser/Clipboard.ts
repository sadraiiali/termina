...
import { stripZeroWidthFormatChars } from 'common/bidi/Bidi';
...
export function paste(text: string, textarea: HTMLTextAreaElement, coreService: ICoreService, optionsService: IOptionsService): void {
  ...
  // iTerm2 PR #709: opt-in strip of ZW format chars, gated on bidi
  if (optionsService.rawOptions.bidi && optionsService.rawOptions.bidiStripZwOnPaste) {
    text = stripZeroWidthFormatChars(text);
  }
