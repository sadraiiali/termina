...
export class DomRenderer extends Disposable implements IRenderer {
  ...
  /** Toggle CSS class so rows use bidi-override (see css/xterm.css). */
  private _syncBidiClass(): void {
    this._element.classList.toggle('xterm-bidi', !!this._optionsService.rawOptions.bidi);
  }
  ...
  public renderRows(start: number, end: number): void {
    ...
    for (let y = start; y <= end; y++) {
      ...
      rowElement.classList.toggle('xterm-bidi-rtl-para', this._rowFactory.lastRowIsRtlParagraph);
      rowElement.classList.toggle('xterm-bidi-has-rtl', this._rowFactory.lastRowHasRtl);
    }
  }
